	...
	_getOptionsForTypeahead() {
	  if (this.state.category == '') {
	    ...
	    for (var i = 0; i < this.props.options.length; i++) {
	      ...
	      let isAllowCustomValue = options.isAllowCustomValue == undefined ? false : options.isAllowCustomValue
	      let isAllowDuplicateCategories = options.isAllowDuplicateCategories == undefined ? true : options.isAllowDuplicateCategories
